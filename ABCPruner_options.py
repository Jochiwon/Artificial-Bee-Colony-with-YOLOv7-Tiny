...
parser.add_argument(
    ...
    type=str,
    default='yolov7-tiny',
    help='Architecture of model. default:yolov7-tiny'
)
...
parser.add_argument(
    ...
    help='model cfg file path. default:yolov7-tiny.yaml'
)
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help='Path to the model weight for Beepruning. default:None'
)
...
parser.add_argument(
    '--hyp',
    type=str,
    help='yolov7-tiny hyp.yaml file path'
)

parser.add_argument(
    '--loss_change',
    action='store_true',
    help='custom loss control. currently, useless option. Don\'t input this option'
)
